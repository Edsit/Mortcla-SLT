...
Public Class Cd_T7
    ...
    Sub Nuevo_T7(ByVal obj As Ce_T7)
        Try
            Cn = objCd_C.Conectar
            If Cn.State = ConnectionState.Closed Then
                Cn.Open()
            End If
            Dim sel As String = "Insert Into T7(C0,C1,C2,C3,C4,C5,C6,C7,C8,C9,C10,C11,C12,C13,C14,C15,C16,C17,C18,C18,C19,C20,C21,Sede)Values(@C0,@C1,@C2,@C3,@C4,@C5,@C6,@C7,@C8,@C9,@C10,@C11,@C12,@C13,@C14,@C15,@C16,@C17,@C18,@C19,@C20,@C21,@Sede)"
        ...
        Catch ex As Exception
            MsgBox("Nuevo_T7 (Cd_T7): " & obj.C2 & ex.Message)
        Finally
            da.Dispose()
            Cn.Dispose()
            Cn.Close()
