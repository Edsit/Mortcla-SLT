...
Public Class FrmEgresosAreas
    ...
    Private Sub ListarAreas()
        Dim ds As New DataSet
        CbAreas.DataSource = Nothing
        CbAreas.Items.Clear()
        Try
            ds = objCn_A.ListarAreasActivas
            If ds.Tables(0).Rows.Count > 0 Then
                CbAreas.DataSource = ds.Tables(0)
                CbAreas.DisplayMember = "Area"
                CbAreas.ValueMember = "Cons"
            End If
        Catch ex As Exception
        Finally
            ds.Dispose()
        End Try
    End Sub
    Private Sub FrmEgresosAreas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub LoadEgresosMesActivo()
        ...
        Try
            ...
            objCe_S.Area = Val(CbAreas.SelectedValue.ToString)
            ds = objCn_S.EgresosPorArea(objCe_S)
            ...
            If c > 0 Then
                ...
                Do
                    ...
                    Dgv.Item(6, i).Value = (ds.Tables(0).Rows(i).Item(3))
    ...
    Private Sub BtnExportar_Click(sender As Object, e As EventArgs) Handles BtnExportar.Click
        ...
        If c > 0 Then
            ...
            With objHojaExcel
                ...
                If RadioButton1.Checked = True Then
                    .Range("C6").Value = TbMes.Text & " " & TbAño.Text
                Else
                    .Range("C6").Value = TbBMes.Text & " " & TbBAño.Text
                End If

                .Range("F6").Value = "Municipio: " '& Mun
                .Range("B7").Value = FrmModulos.LbSede.Text
                .Range("B13").Value = "TIPO DE INSUMO: MEDICAMENTOS (" & UCase(CbAreas.Text) & ")"

                If RadioButton1.Checked = True Then
                    .Range("D10").Value = "KARDEX DE MEDICAMENTOS " & TbMes.Text & " " & TbAño.Text
                Else
                    .Range("D10").Value = "KARDEX DE MEDICAMENTOS " & TbBMes.Text & " " & TbBAño.Text
                End If
